...
public class Assignment2ServiceImpl implements Assignment2Service {
	...
	@Override
	public List<List<Integer>> Allsubsets(Assignment2Request request) {
	...
	@Override
	public int getEvenSubsetCount(Assignment2Request request) {
		// TODO Auto-generated method stub
		List<List<Integer>> powerset = new ArrayList<>();
		powerset.add(new ArrayList<>());
		int[] numbers = request.getNumbers();
	...
	@Override
	public int[] getImmidiateSmallerElement(Assignment2Request assignment2Request) {
	...
	@Override
	public int[] getZigZagArray(Assignment2Request assignment2Request) {
	...
	@Override
	public int getThirdLargestElement(Assignment2Request assignment2Request) {
		int[] number = assignment2Request.getNumbers();
		if (number.length < 3)
			return 0;
		Arrays.sort(number);
	...
	@Override
	public List<Integer> getSmallestAndSecondSmallestElement(Assignment2Request assignment2Request) {
		int[] numbers = assignment2Request.getNumbers();
	...
	@Override
	public HashMap<String, Integer> getFirstAndLastoccuerence(Assignment2Request assignment2Request, int x) {
		int[] number = assignment2Request.getNumbers();
	...
	@Override
	public boolean getUniqueNumberOfOccurence(Assignment2Request assignment2Request) {
	...
	@Override
	public List<ArrayList<Integer>> getStockBuyAndSell(Assignment2Request assignment2Request) {
	...
	@Override
	public int maxProfit(Assignment2Request assignment2Request) {
		int[] numbers = assignment2Request.getNumbers();
		int maxProfit = 0;
		for (int i = 0; i < numbers.length - 1; i++) {
			if (numbers[i] < numbers[i + 1]) {
	...
	@Override
	public int getMissingnumber(Assignment2Request assignment2Request) {
		int[] number = assignment2Request.getNumbers();
		Arrays.sort(number);
		int cnt=number[0];
		for(int i=0;i<number.length;i++)
	...
	@Override
	public int getKthSmallestNumber(Assignment2Request assignment2Request,int k) {
		int[] number = assignment2Request.getNumbers();
		Arrays.sort(number);
		if (number.length < k)
			return -1;
	...
	@Override
	public int getEquilibriumPoint(Assignment2Request assignment2Request) {
		int[] number = assignment2Request.getNumbers();
	...
	@Override
	public int secondLargestElement(Assignment2Request assignment2Request) {
		int[] number = assignment2Request.getNumbers();
	...
	@Override
	public int getSumPairs(Assignment2Request assignment2Request, int k) {
		int[] number = assignment2Request.getNumbers();
		int cnt=0;
		for(int i=0;i<number.length;i++)
		{
	...
	@Override
	public int getMaxProduct(Assignment2Request assignment2Request) {
